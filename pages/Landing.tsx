...
// 3D Rotating Box Component (CSS 3D)
const RotatingBox = ({ delay = 0 }) => {
  return (
    <div style={{
      position: 'absolute',
      width: '120px',
...
// Floating Sphere Component (CSS 3D)
const FloatingSphere = ({ top, left, delay = 0, size = 100 }) => {
  return (
    <div style={{
      position: 'absolute',
      top: `${top}%`,
      ...
      height: `${size}px`,
      borderRadius: '50%',
      background: 'radial-gradient(circle at 30% 30%, rgba(124,92,252,0.4), rgba(124,92,252,0.1))',
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#FFFFFF', color: '#1E293B', fontFamily: 'DM Sans, sans-serif', overflowX: 'hidden' }}>
      ...
      <section style={{ position: 'relative', zIndex: 1, paddingTop: 140, paddingBottom: 100, textAlign: 'center', padding: '140px 24px 100px', overflow: 'hidden' }}>
        ...
        <FloatingSphere top={10} left={5} delay={0} size={150} />
        <FloatingSphere top={60} left={85} delay={1} size={120} />
        <FloatingSphere top={70} left={10} delay={2} size={100} />
        <RotatingBox delay={0} />
        ...
        <div style={{ maxWidth: 1000, margin: '72px auto 0', position: 'relative', perspective: '1000px' }}>
          <div style={{ background: 'linear-gradient(135deg, rgba(124,92,252,0.1), rgba(124,92,252,0.03))', border: '1px solid rgba(124,92,252,0.15)', borderRadius: 24, padding: 3, boxShadow: '0 40px 100px rgba(0,0,0,0.1), 0 0 60px rgba(124,92,252,0.06)', transform: 'perspective(1200px) rotateX(5deg)', transition: 'transform 0.3s ease' }}>
        ...
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 20 }}>
            {[
              ...
              <div key={i} style={{ padding: 24, background: '#FFFFFF', border: '1px solid rgba(0,0,0,0.07)', borderRadius: 20, position: 'relative', transition: 'all 0.3s ease', cursor: 'default' }}
                onMouseEnter={e => { 
      ...
      <footer style={{ position: 'relative', zIndex: 1, borderTop: '1px solid rgba(0,0,0,0.06)', padding: '40px 24px', background: '#F8F9FC' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 20 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <span style={{ ...S, fontSize: 15, fontWeight: 700, color: '#0F172A' }}>FreightIntel<span style={{ background: 'linear-gradient(135deg, #7C5CFC, #A78BFA)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', fontSize: '8px' }}>Pro</span></span>
          </div>
